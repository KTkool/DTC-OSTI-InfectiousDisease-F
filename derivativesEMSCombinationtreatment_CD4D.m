...
function [ dy ] = derivativesEMSCombinationtreatment_CD4D( t, y, param )
...
%particles (VNI). CD4D means that CD4 cells will die at a certain rate due to the drug
% treatment
...
dy(2) = (1-param.RTT)*param.beta*y(1)*y(3)- (param.dr + param.alpha*param.d + param.k0 * y(2)/(y(2)+param.theta)) *y(2);
dy(3) = (1 - param.PI)*param.alpha*param.d*param.p*y(2)-param.c*y(3);
dy(4) = param.PI *param.alpha*param.d*param.p*y(2)-param.c*y(4);
